...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_start_time: 40.193 0.475 1170.436 0.004 0
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 40.359 0.475 1170.601 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 40.626 0.483 1170.875 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 43.678 0.503 1173.947 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 43.866 0.503 1174.135 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 44.104 0.503 1174.372 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 44.329 0.507 1174.6 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 47.65 0.519 1177.934 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    Warning message:
    "Ignoring unknown aesthetics: fun"Don't know how to automatically pick scale for object of type function. Defaulting to continuous.
    ERROR while rich displaying an object: Error: Column `fun` must be a 1d atomic vector or a list
    ...
    26. as_tibble.list(x)
    27. list_to_tibble(x, validate)
    28. check_tibble(x)
    29. invalid_df("must be [a] 1d atomic vector(s) or [a] list(s)", 
      .     x, !is_1d)
    30. stopc(pluralise_msg("Column(s) ", vars), " ", pluralise(problem, 
      .     vars))
    31. abort(paste0(...))
