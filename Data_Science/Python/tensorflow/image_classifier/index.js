...
function loadRandom() {
  //car. dog, cat, person, house	
  var arr = ['car', 'dog', 'cat', 'person', 'house', 'airplane', 'boat'];
  var choiceIndex = Math.floor(Math.random() * arr.length) 		
  document.getElementById('image').src='https://loremflickr.com/224/224/' + arr[choiceIndex] + '?random='+Date.now();
